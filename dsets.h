...
class DisjointSets
{
	public:
		...
		* If the two sets are the same size, make the tree containing the second argument point to the
		* tree containing the first. (Note that normally we could break this tie arbitrarily, but
